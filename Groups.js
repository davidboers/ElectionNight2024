...
var $author$project$Groups$Model = F3(
	function (axies, summary, err) {
		return {axies: axies, err: err, summary: summary};
	});
var $author$project$Office$President = {$: 'President'};
var $author$project$Groups$ResultFetched = function (a) {
	return {$: 'ResultFetched', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Groups$AxiesFetched = function (a) {
	return {$: 'AxiesFetched', a: a};
};
var $author$project$Groups$Axis = F2(
	function (name, groups) {
		return {groups: groups, name: name};
	});
var $author$project$Groups$Group = F2(
	function (name, units) {
...
var $author$project$Groups$decodeGroup = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Groups$Group,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'states',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$Groups$decodeAxis = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Groups$Axis,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'groups',
		$elm$json$Json$Decode$list($author$project$Groups$decodeGroup)));
...
var $author$project$Groups$fetchAxies = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			$author$project$Groups$AxiesFetched,
			$elm$json$Json$Decode$list($author$project$Groups$decodeAxis)),
		url: './state-agg.json'
	});
...
var $author$project$Groups$init = function (_v0) {
	return _Utils_Tuple2(
		A3($author$project$Groups$Model, _List_Nil, _List_Nil, $elm$core$Maybe$Nothing),
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($author$project$Contest$fetchResult, $author$project$Groups$ResultFetched, $author$project$Office$President),
					$author$project$Groups$fetchAxies
				])));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Groups$MetaFetched = function (a) {
	return {$: 'MetaFetched', a: a};
};
var $author$project$Groups$PreviousFetched = function (a) {
	return {$: 'PreviousFetched', a: a};
};
var $author$project$Groups$CountyFetched = F2(
	function (a, b) {
...
var $author$project$Groups$fetchCounties = function (c) {
	return $elm$http$Http$get(
		{
			expect: A2(
				$elm$http$Http$expectJson,
				$author$project$Groups$CountyFetched(c.id),
				A2(
					$elm$json$Json$Decode$field,
					'counties',
...
var $author$project$Main$insertHistResults = F3(
	function (summary, office, txt) {
		var select_line = F3(
		...
		return A2($elm$core$List$map, insertContestResults, summary);
	});
...
var $author$project$Groups$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ResultFetched':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{summary: summary}),
						A2($author$project$Contest$fetchMeta, $author$project$Groups$MetaFetched, $author$project$Office$President));
				} else {
					var e = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'MetaFetched':
				if (msg.a.$ === 'Ok') {
					var meta = msg.a.a;
					var summary = $author$project$Main$sortSummary(
						A2($author$project$Contest$mergeMetas, meta, model.summary));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{summary: summary}),
						$elm$core$Platform$Cmd$batch(
							A2(
								$elm$core$List$cons,
								$author$project$Contest$fetchPreviousResults($author$project$Groups$PreviousFetched),
								A2($elm$core$List$map, $author$project$Groups$fetchCounties, summary))));
				} else {
					var e = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
				...
				if (msg.b.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								summary: updateContest(model.summary)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var e = msg.b.a;
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								summary: A3($author$project$Main$insertHistResults, model.summary, $author$project$Office$President, txt)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var e = msg.a.a;
...
var $author$project$Groups$tally_funcs = _List_fromArray(
	[
		function ($) {
		return $.harris;
	},
...
var $author$project$Groups$tallyTotalHelper = F2(
	function (tplfunc, t) {
		return $elm$core$List$sum(
			A2(
				...
				A2(
					...
					$author$project$Groups$tally_funcs)));
	});
var $author$project$Groups$tallyTotalLast = $author$project$Groups$tallyTotalHelper($elm$core$Tuple$second);
var $author$project$Groups$tallyTotalNow = $author$project$Groups$tallyTotalHelper($elm$core$Tuple$first);
var $author$project$Groups$cndShare = F2(
	function (t, cmd) {
		var _v0 = _Utils_Tuple2(
			$author$project$Groups$tallyTotalNow(t),
			$author$project$Groups$tallyTotalLast(t));
		var total_now = _v0.a;
		var total_last = _v0.b;
		var _v1 = cmd(t);
		var now = _v1.a;
		var last = _v1.b;
		var last_shr = last / total_last;
		var shr_now = now / total_now;
		return _Utils_Tuple2(shr_now, shr_now - last_shr);
	});
var $author$project$Groups$parties = _List_fromArray(
	['dem', 'gop', 'ind', 'grn', 'lib', 'ind', 'oth']);
var $elm$html$Html$br = _VirtualDom_node('br');
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$Groups$displayPct = function (flt) {
	return $elm$core$String$fromFloat(
		$elm$core$Basics$round(flt * 1000) / 10);
};
...
var $author$project$Groups$shareCell = F2(
	function (_v0, pty) {
		var now = _v0.a;
		var chg = _v0.b;
		return A2(
			...
			_List_fromArray(
				[
					...
					'background-color',
					A2($author$project$ShadePalettes$getPartyShade, pty, now)) : A2($elm$html$Html$Attributes$style, 'background-color', 'white'),
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$author$project$Groups$displayPct(now)),
					...
					_List_fromArray(
						[
							(chg >= 0) ? $elm$html$Html$text(
							'+' + $author$project$Groups$displayPct(chg)) : $elm$html$Html$text(
							$author$project$Groups$displayPct(chg))
						]))
				]));
	});
...
var $author$project$Groups$harrisID = '64984';
var $author$project$Groups$kennedyID = '71841';
var $author$project$Groups$oliverID = '69459';
var $author$project$Groups$steinID = '895';
var $author$project$Groups$trumpID = '8639';
var $author$project$Groups$westID = '71845';
var $author$project$Groups$ids = _List_fromArray(
	[$author$project$Groups$harrisID, $author$project$Groups$trumpID, $author$project$Groups$kennedyID, $author$project$Groups$steinID, $author$project$Groups$oliverID, $author$project$Groups$westID]);
var $author$project$Groups$tally = F2(
	function (summary, filter_group) {
		var filtered_contests = function () {
			if (filter_group.$ === 'Just') {
				var group = filter_group.a;
				return A2(
					$elm$core$List$filter,
					function (c) {
						return A2(
							$elm$core$List$member,
							$author$project$Contest$fipsToName(
								A2(
									$elm$core$Maybe$withDefault,
									'00',
									A2(
		...
		var counties = $elm$core$List$concat(
			A2(
				$elm$core$List$filterMap,
				function ($) {
					return $.counties;
				...
				filtered_contests));
		var tallyCandidateLast = function (cnd_id) {
			return $elm$core$List$sum(
				A2(
					$elm$core$List$filterMap,
					A2(
						$elm$core$Basics$composeL,
						$elm$core$Dict$get(cnd_id),
						function ($) {
							return $.swing_from;
						}),
					counties));
		};
		var tallyOthersLast = $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				...
				A2(
					...
					function (_v0) {
						var cnd_id = _v0.a;
						return !A2($elm$core$List$member, cnd_id, $author$project$Groups$ids);
					},
					A2(
		...
		var allresults = A2(
			...
			filtered_contests);
		var filterCandidates = function (cnd_id) {
			return A2(
				$elm$core$List$filter,
				function (cnd) {
		...
		var tallyCandidate = function (cnd_id) {
			return $elm$core$List$sum(
				A2(
					$elm$core$List$map,
					function ($) {
		...
		var tallyOthers = $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				function ($) {
					return $.votes;
				...
				A2(
					$elm$core$List$filter,
					function (cnd) {
						return !A2($elm$core$List$member, cnd.cnd_id, $author$project$Groups$ids);
					},
					allresults)));
		return {
			harris: _Utils_Tuple2(
				tallyCandidate($author$project$Groups$harrisID),
				tallyCandidateLast($author$project$Groups$harrisID)),
			kennedy: _Utils_Tuple2(
				tallyCandidate($author$project$Groups$kennedyID),
				tallyCandidateLast($author$project$Groups$kennedyID)),
			oliver: _Utils_Tuple2(
				tallyCandidate($author$project$Groups$oliverID),
				tallyCandidateLast($author$project$Groups$oliverID)),
			other: _Utils_Tuple2(tallyOthers, tallyOthersLast),
			stein: _Utils_Tuple2(
				tallyCandidate($author$project$Groups$steinID),
				tallyCandidateLast($author$project$Groups$steinID)),
			trump: _Utils_Tuple2(
				tallyCandidate($author$project$Groups$trumpID),
				tallyCandidateLast($author$project$Groups$trumpID)),
			west: _Utils_Tuple2(
				tallyCandidate($author$project$Groups$westID),
				tallyCandidateLast($author$project$Groups$westID))
		};
	});
var $elm$html$Html$th = _VirtualDom_node('th');
var $elm$html$Html$tr = _VirtualDom_node('tr');
var $author$project$Groups$displayGroup = F2(
	function (summary, group) {
		...
		return A2(
			...
			A2(
				...
				A3(
					$elm$core$List$map2,
					$author$project$Groups$shareCell,
					A2(
						$elm$core$List$map,
						$author$project$Groups$cndShare(
							A2($author$project$Groups$tally, summary, group)),
						$author$project$Groups$tally_funcs),
					$author$project$Groups$parties)));
	});
...
var $author$project$Groups$candidateHeaders = function (summary) {
	var top_style = _List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'width', '100px')
		]);
	var color_style = _List_fromArray(
		[
					...
					return A2(
						...
						A2(
							...
							A2(
								$elm$html$Html$Attributes$style,
								'background-color',
								$author$project$ShadePalettes$partyColor(pty)),
							color_style),
						_List_Nil);
				},
				$author$project$Groups$parties)),
			A2($author$project$Groups$displayGroup, summary, $elm$core$Maybe$Nothing)
		]);
};
...
var $author$project$Groups$displayAxis = F2(
	function (summary, axis) {
		return A2(
			$elm$core$List$cons,
			A2(
				$elm$html$Html$tr,
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$List$length($author$project$Groups$parties)),
								A2($elm$html$Html$Attributes$style, 'border', '1px solid gray')
							]),
						_List_fromArray(
							[
			...
			A2(
				$elm$core$List$map,
				$author$project$Groups$displayGroup(summary),
				A2($elm$core$List$map, $elm$core$Maybe$Just, axis.groups)));
	});
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Groups$loading = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Groups$view = function (model) {
	var _v0 = _Utils_Tuple3(model.axies, model.summary, model.err);
	if (_v0.c.$ === 'Just') {
		if (_v0.c.a.$ === 'BadBody') {
			var msg = _v0.c.a.a;
		...
		if (!_v0.a.b) {
			return $author$project$Groups$loading;
		} else {
			if (!_v0.b.b) {
				return $author$project$Groups$loading;
			} else {
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_Utils_ap(
								$author$project$Groups$candidateHeaders(summary),
								A2(
									$elm$core$List$concatMap,
									$author$project$Groups$displayAxis(summary),
									axies)))
						]));
			}
		}
...
var $author$project$Groups$main = $elm$browser$Browser$document(
	{
		init: $author$project$Groups$init,
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$Groups$update,
		view: function (model) {
			return {
				body: _List_fromArray(
					[
						$author$project$Groups$view(model)
					]),
				title: 'Groups of states'
			};
		}
	});
_Platform_export({'Groups':{'init':$author$project$Groups$main(

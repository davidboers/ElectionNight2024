...
var $author$project$Analysis$Democratic = {$: 'Democratic'};
var $author$project$Analysis$GeorgiaResultFetched = function (a) {
	return {$: 'GeorgiaResultFetched', a: a};
};
var $author$project$Office$Governor = {$: 'Governor'};
var $author$project$Office$House = {$: 'House'};
var $author$project$Analysis$Model = function (party) {
	return function (state) {
		return function (analysis) {
			return function (pres) {
				return function (senate) {
					return function (house) {
						return function (gov) {
							return function (state_senate) {
								return function (state_house) {
									return function (abortion) {
										return function (hist_pres) {
											return function (battleground_list) {
												return function (err) {
													return {abortion: abortion, analysis: analysis, battleground_list: battleground_list, err: err, gov: gov, hist_pres: hist_pres, house: house, party: party, pres: pres, senate: senate, state: state, state_house: state_house, state_senate: state_senate};
												};
											};
										};
									};
...
var $author$project$Analysis$Presidential = {$: 'Presidential'};
var $author$project$Analysis$ResultFetched = F2(
	function (a, b) {
		return {$: 'ResultFetched', a: a, b: b};
	});
var $author$project$Office$Senate = {$: 'Senate'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Analysis$BattlegroundsFetched = function (a) {
	return {$: 'BattlegroundsFetched', a: a};
};
...
var $author$project$Analysis$decodeBattlegrounds = $elm$json$Json$Decode$dict(
...
var $author$project$Analysis$fetchBattlegrounds = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Analysis$BattlegroundsFetched, $author$project$Analysis$decodeBattlegrounds),
		url: './battlegrounds.json'
	});
var $author$project$Analysis$HistFetched = function (a) {
	return {$: 'HistFetched', a: a};
};
var $author$project$Analysis$HistPres = F2(
	function (nominees, state_results) {
		return {nominees: nominees, state_results: state_results};
	});
var $elm$json$Json$Decode$array = _Json_decodeArray;
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $author$project$Analysis$decodePresidential = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Analysis$HistPres,
	A2(
...
var $author$project$Analysis$fetchHistPres = $elm$http$Http$get(
	{
...
var $author$project$Analysis$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Analysis$Model($author$project$Analysis$Democratic)('01')($author$project$Analysis$Presidential)(_List_Nil)(_List_Nil)(_List_Nil)(_List_Nil)(_List_Nil)(_List_Nil)(_List_Nil)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing),
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(
					$author$project$Contest$fetchResult,
					$author$project$Analysis$ResultFetched($author$project$Office$President),
					$author$project$Office$President),
					A2(
					$author$project$Contest$fetchResult,
					$author$project$Analysis$ResultFetched($author$project$Office$Senate),
					$author$project$Office$Senate),
					A2(
					$author$project$Contest$fetchResult,
					$author$project$Analysis$ResultFetched($author$project$Office$House),
					$author$project$Office$House),
					A2(
					$author$project$Contest$fetchResult,
					$author$project$Analysis$ResultFetched($author$project$Office$Governor),
					$author$project$Office$Governor),
					$author$project$Georgia$fetchResult($author$project$Analysis$GeorgiaResultFetched),
					A2(
					$author$project$Contest$fetchResult,
					$author$project$Analysis$ResultFetched($author$project$Office$AbortionQuestions),
					$author$project$Office$AbortionQuestions),
					$author$project$Analysis$fetchHistPres,
					$author$project$Analysis$fetchBattlegrounds
				])));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Analysis$MetaFetched = F2(
	function (a, b) {
	...
	function (msg, model) {
		switch (msg.$) {
						...
						case 'President':
							...
							return _Utils_Tuple2(
								_Utils_update(
									...
									{pres: summary}),
								A2(
									$author$project$Contest$fetchMeta,
									$author$project$Analysis$MetaFetched($author$project$Office$President),
									$author$project$Office$President));
						case 'Senate':
							var _v2 = msg.a;
							var summary = msg.b.a;
							return _Utils_Tuple2(
								...
								A2(
									$author$project$Contest$fetchMeta,
									$author$project$Analysis$MetaFetched($author$project$Office$Senate),
									$author$project$Office$Senate));
						case 'House':
							var _v3 = msg.a;
							var summary = msg.b.a;
							return _Utils_Tuple2(
								...
								A2(
									$author$project$Contest$fetchMeta,
									$author$project$Analysis$MetaFetched($author$project$Office$House),
									$author$project$Office$House));
						case 'Governor':
							var _v4 = msg.a;
							var summary = msg.b.a;
							return _Utils_Tuple2(
								...
								A2(
									$author$project$Contest$fetchMeta,
									$author$project$Analysis$MetaFetched($author$project$Office$Governor),
									$author$project$Office$Governor));
						case 'AbortionQuestions':
							var _v5 = msg.a;
							var summary = msg.b.a;
							return _Utils_Tuple2(
								...
								A2(
									$author$project$Contest$fetchMeta,
									$author$project$Analysis$MetaFetched($author$project$Office$AbortionQuestions),
									$author$project$Office$AbortionQuestions));
						default:
			...
			case 'GeorgiaResultFetched':
				if (msg.a.$ === 'Ok') {
					var georgia_summary = msg.a.a;
					var summary = A2($elm$core$List$map, $author$project$Georgia$fromGeorgia, georgia_summary);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								state_house: A2(
									...
									$author$project$Contest$officeIs($author$project$Office$StateHouse),
									summary),
								state_senate: A2(
									$elm$core$List$filter,
									$author$project$Contest$officeIs($author$project$Office$StateSenate),
									summary)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
						...
						case 'President':
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										pres: A2($author$project$Contest$mergeMetas, meta, model.pres)
									}),
								$elm$core$Platform$Cmd$none);
						case 'Senate':
							var _v7 = msg.a;
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										senate: A2($author$project$Contest$mergeMetas, meta, model.senate)
									}),
								$elm$core$Platform$Cmd$none);
						case 'House':
							var _v8 = msg.a;
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										house: A2($author$project$Contest$mergeMetas, meta, model.house)
									}),
								$elm$core$Platform$Cmd$none);
						case 'Governor':
							var _v9 = msg.a;
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										gov: A2($author$project$Contest$mergeMetas, meta, model.gov)
									}),
								$elm$core$Platform$Cmd$none);
						case 'AbortionQuestions':
							var _v10 = msg.a;
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										abortion: A2($author$project$Contest$mergeMetas, meta, model.abortion)
									}),
								$elm$core$Platform$Cmd$none);
						default:
							return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								hist_pres: $elm$core$Maybe$Just(hist)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var e = msg.a.a;
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								battleground_list: $elm$core$Maybe$Just(lst)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var e = msg.a.a;
...
var $author$project$Analysis$battlegroundSet = function (_v0) {
	var office = _v0.a;
	var contests = _v0.b;
	var header = function () {
		switch (office.$) {
			...
			case 'House':
				return 'US House';
			case 'StateSenate':
				return 'Georgia Senate';
			case 'StateHouse':
				return 'Georgia House';
			default:
				return 'Others';
		}
	}();
	var blockStyle = _List_fromArray(
		[
			...
			[
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeL,
							$elm$html$Html$div(blockStyle),
							$elm$core$List$singleton),
						$author$project$Contest$smallContestResults($author$project$Contest$getSmallName)),
					contests))
			]));
};
var $elm$html$Html$hr = _VirtualDom_node('hr');
var $author$project$Analysis$loading = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Analysis$battleground = function (model) {
	var _v0 = _Utils_Tuple2(
		model.battleground_list,
		_Utils_Tuple3(
			model.pres,
			model.senate,
			_Utils_Tuple3(model.house, model.state_senate, model.state_house)));
	if (_v0.a.$ === 'Nothing') {
		var _v1 = _v0.a;
				...
				if (!_v0.b.c.a.b) {
					...
					if (!_v0.b.c.b.b) {
						...
						if (!_v0.b.c.c.b) {
							...
							var battleground_list = _v0.a.a;
							var isBattleground = F2(
								function (office, contest) {
									var _v12 = A2(
										$elm$core$Dict$get,
										$author$project$Office$toString(office),
										battleground_list);
									if (_v12.$ === 'Just') {
										var ids = _v12.a;
										return A2($elm$core$List$member, contest.id, ids);
									} else {
										return false;
									}
								});
							var pres = A2(
								$elm$core$List$filter,
								isBattleground($author$project$Office$President),
								model.pres);
							var senate = A2(
								$elm$core$List$filter,
								isBattleground($author$project$Office$Senate),
								model.senate);
							var state_house = A2(
								$elm$core$List$filter,
								isBattleground($author$project$Office$StateHouse),
								model.state_house);
							var state_senate = A2(
								$elm$core$List$filter,
								isBattleground($author$project$Office$StateSenate),
								model.state_senate);
							var house = A2(
								$elm$core$List$filter,
								isBattleground($author$project$Office$House),
								model.house);
							return A2(
								$elm$html$Html$div,
								_List_fromArray(
								...
								A2(
									...
									A2(
										$elm$core$List$map,
										$author$project$Analysis$battlegroundSet,
										_List_fromArray(
											[
												_Utils_Tuple2($author$project$Office$President, pres),
												_Utils_Tuple2($author$project$Office$Senate, senate),
												_Utils_Tuple2($author$project$Office$House, house),
												_Utils_Tuple2($author$project$Office$StateSenate, state_senate),
												_Utils_Tuple2($author$project$Office$StateHouse, state_house)
											]))));
						}
					}
				}
...
var $author$project$Analysis$electionYears = $elm$core$Array$fromList(
	A2(
		$elm$core$List$map,
		$elm$core$String$fromInt,
		A2(
			...
			A2(
				...
				4,
				A2($elm$core$List$range, 1976, 2024)))));
var $author$project$Analysis$mapArray2 = F3(
	function (func, a, b) {
...
var $author$project$Analysis$partyToString = function (party) {
	if (party.$ === 'Democratic') {
		return 'dem';
	} else {
		return 'gop';
...
var $author$project$Analysis$numElections = $elm$core$Array$length($author$project$Analysis$electionYears);
var $author$project$Analysis$equalPct = (1 / $author$project$Analysis$numElections) * 100;
var $author$project$Analysis$presNominee = F3(
	function (_v0, year, nominee) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					'width',
					$elm$core$String$fromFloat($author$project$Analysis$equalPct) + '%'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(nominee)
						]))
				]));
	});
var $author$project$Analysis$bottomRow = F2(
	function (model, hist_pres) {
		var _v0 = A2(
			$elm$core$Dict$get,
			$author$project$Analysis$partyToString(model.party),
			hist_pres.nominees);
		if (_v0.$ === 'Just') {
			var nominees = _v0.a;
			return A2(
				...
				$elm$core$Array$toList(
					A3(
						$author$project$Analysis$mapArray2,
						$author$project$Analysis$presNominee(model),
						$author$project$Analysis$electionYears,
						nominees)));
		} else {
			return A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Party not found')
					]));
		}
	});
...
var $author$project$Analysis$isParty = F2(
	function (party, j) {
		var _v0 = _Utils_Tuple2(party, j.party);
		_v0$2:
		while (true) {
			if (_v0.a.$ === 'Democratic') {
				if ((_v0.b.$ === 'Just') && (_v0.b.a === 'dem')) {
					var _v1 = _v0.a;
					return true;
				} else {
					break _v0$2;
...
var $author$project$Analysis$partyColor = function (party) {
	if (party.$ === 'Democratic') {
		return $author$project$ShadePalettes$partyColor('dem');
	} else {
		return $author$project$ShadePalettes$partyColor('gop');
	}
};
...
var $author$project$Analysis$graphPresHist = F3(
	function (party, array, pres_state) {
		var votes2024 = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2(
				...
				A2(
					...
					$author$project$Analysis$isParty(party),
					pres_state.results)));
		var verticalAxis = function (_v4) {
			var x = _v4.a;
			return A2(
				$elm$svg$Svg$line,
				_List_fromArray(
		...
		var total2024 = $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				function ($) {
					return $.votes;
				...
				pres_state.results));
		var show24 = $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				function ($) {
					return $.votes;
				},
				pres_state.results)) > 0;
		var shareText = F2(
			function (_v3, s) {
				var x_ = _v3.a;
				var y_ = _v3.b;
				return A2(
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromFloat(x_ - 1) + '%'),
							$elm$svg$Svg$Attributes$y(
							$elm$core$String$fromFloat(y_ - 3) + '%')
						]),
					_List_fromArray(
						[
							$elm$svg$Svg$text(
							A2(
								$elm$core$String$left,
								5,
								$elm$core$String$fromFloat(s * 100)))
						]));
			});
		var share2024 = votes2024 / total2024;
		...
		var full_array = show24 ? _Utils_ap(
			$elm$core$Array$toList(array),
			_List_fromArray(
				[share2024])) : $elm$core$Array$toList(array);
		var coord = F2(
			function (x, y) {
				return _Utils_Tuple2((x * $author$project$Analysis$equalPct) - ($author$project$Analysis$equalPct / 2), (1 - y) * 100);
			});
		var coords = A3(
			$elm$core$List$map2,
			coord,
			A2($elm$core$List$range, 1, $author$project$Analysis$numElections),
			full_array);
		return $elm$core$List$concat(
			_List_fromArray(
				[
					A2($elm$core$List$map, verticalAxis, coords),
					A3(
					$elm$core$List$map2,
					line_,
					coords,
					A2($elm$core$List$drop, 1, coords)),
					A2($elm$core$List$map, point, coords),
					A3($elm$core$List$map2, shareText, coords, full_array)
				]));
	});
var $author$project$Analysis$isState = F2(
	function (model, c) {
		var c_fips = A2(
			$elm$core$Maybe$withDefault,
			'00',
			A2(
				...
				c.meta));
		return _Utils_eq(c_fips, model.state);
	});
var $elm$svg$Svg$svg = $elm$svg$Svg$trustedNode('svg');
var $author$project$Analysis$presidential = function (model) {
	var _v0 = _Utils_Tuple2(model.pres, model.hist_pres);
	_v0$0:
	while (true) {
		if (_v0.b.$ === 'Nothing') {
			if (!_v0.a.b) {
			...
			if (!_v0.a.b) {
				...
				var pres = _v0.a;
				var hist_pres = _v0.b.a;
				var _v2 = A2(
					$elm_community$list_extra$List$Extra$find,
					$author$project$Analysis$isState(model),
					pres);
				if (_v2.$ === 'Just') {
					var pres_state = _v2.a;
					return A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'height', '550px'),
										A2($elm$html$Html$Attributes$style, 'width', 'inherit'),
										A2($elm$html$Html$Attributes$style, 'border-bottom', '2px solid black')
									]),
								_List_fromArray(
									[
										function () {
										var _v3 = A2(
											...
											$elm$core$Dict$get(
												$author$project$Analysis$partyToString(model.party)),
											A2($elm$core$Dict$get, model.state, hist_pres.state_results));
										if (_v3.$ === 'Just') {
											var array = _v3.a;
											return A2(
												$elm$svg$Svg$svg,
												...
												A3($author$project$Analysis$graphPresHist, model.party, array, pres_state));
										} else {
											return A2(
												$elm$html$Html$div,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text('State or party not found')
													]));
										}
									}()
									])),
								A2($author$project$Analysis$bottomRow, model, hist_pres)
							]));
				} else {
					return A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Cannot find 2024 Presidential contest from that state.')
							]));
				}
			}
		}
		...
		if (_v0.$ === 'Just') {
			...
			var total = $elm$core$List$sum(
				A2(
					...
					c.results));
			var spacing = 10;
			var office = $author$project$Office$toString(meta.office);
			var leftStyle = _List_fromArray(
				[
			...
			var candidates = A2(
				$elm$core$List$filter,
				$author$project$Analysis$isParty(model.party),
				c.results);
			var votes = $elm$core$List$sum(
				A2(
					$elm$core$List$map,
					function ($) {
						return $.votes;
					...
					candidates));
			var share = $elm$core$Basics$round((votes / total) * 100);
			var barHeight = 50;
			var rowStyle = _List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'padding',
					$elm$core$String$fromInt(spacing) + 'px'),
					A2($elm$html$Html$Attributes$style, 'display', 'flex'),
					A2($elm$html$Html$Attributes$style, 'width', 'inherit'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromInt(barHeight) + 'px'),
					A2($elm$html$Html$Attributes$style, 'border-right', '2px solid black')
				]);
			if (!candidates.b) {
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(office)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'text-wieght', 'italics')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Did not contest')
								]))
						]));
			} else {
				var cnds = candidates;
				var cnd_name = function () {
					if (cnds.b && (!cnds.b.b)) {
						var cnd = cnds.a;
						return cnd.name;
					} else {
						return $elm$core$String$fromInt(
							$elm$core$List$length(cnds)) + ' candidates';
					}
				}();
				return A2(
					$elm$html$Html$div,
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'background-color',
									$author$project$Analysis$partyColor(model.party))
								]),
							_List_Nil),
							A2(
							$elm$html$Html$div,
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$author$project$DisplayNumber$displayNumber(
										$elm$core$Basics$round(votes))),
									A2($elm$html$Html$br, _List_Nil, _List_Nil),
									$elm$html$Html$text(
									$elm$core$String$fromInt(share) + '%')
								]))
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('No meta: ' + c.id),
						A2($elm$html$Html$br, _List_Nil, _List_Nil)
					]));
		}
	});
var $author$project$Analysis$compareState = F2(
	function (model, contests) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			A2(
				$elm$core$List$map,
				$author$project$Analysis$displayBar(model),
				contests));
	});
...
var $author$project$Analysis$mergeHouseContests = function (summary) {
	var _v0 = A2(
		...
		function (c) {
			return A2(
				...
				A2(
					$elm$core$Maybe$map,
					$elm$core$Basics$eq($author$project$Office$House),
					A2(
						$elm$core$Maybe$map,
						function ($) {
							return $.office;
	...
	return A2(
		$elm$core$List$cons,
		{
			...
			meta: $elm$core$Maybe$Just(
				{
					district: $elm$core$Maybe$Nothing,
					fips: '',
					holdingParty: '',
					isReferendum: false,
					isSpecial: false,
					isUncontested: $elm$core$List$length(results) === 1,
					office: $author$project$Office$House
				}),
			progress: 0,
			results: results,
			timestamp: ''
...
var $author$project$Analysis$stateComparison = function (model) {
	var _v0 = _Utils_Tuple3(
		model.pres,
		model.senate,
		_Utils_Tuple3(model.house, model.gov, model.abortion));
	if (!_v0.a.b) {
		var _v1 = _v0.c;
		return $author$project$Analysis$loading;
	} else {
			...
			if (!_v0.c.a.b) {
				...
				if (!_v0.c.b.b) {
					...
					if (!_v0.c.c.b) {
						...
						var abortion = _v6.c;
						return A2(
							$author$project$Analysis$compareState,
							model,
							$author$project$Analysis$mergeHouseContests(
								A2(
									$elm$core$List$filter,
									$author$project$Analysis$isState(model),
									$elm$core$List$concat(
...
var $author$project$Analysis$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						A2($author$project$Analysis$toggleButtonStyle, model.party, $author$project$Analysis$Democratic),
						_List_fromArray(
							[
								$elm$html$Html$text('DEM')
							])),
						A2(
						$elm$html$Html$div,
						A2($author$project$Analysis$toggleButtonStyle, model.party, $author$project$Analysis$Republican),
						_List_fromArray(
							[
								$elm$html$Html$text('GOP')
							]))
					])),
				function () {
				var _v0 = model.analysis;
				switch (_v0.$) {
					case 'StateComparison':
						return $author$project$Analysis$stateComparison(model);
					case 'Presidential':
						return $author$project$Analysis$presidential(model);
					default:
						return $author$project$Analysis$battleground(model);
				}
			}()
			]));
};
var $author$project$Analysis$main = $elm$browser$Browser$document(
	{
		init: $author$project$Analysis$init,
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$Analysis$update,
		view: function (model) {
			return {
				body: _List_fromArray(
					[
						$author$project$Analysis$view(model)
					]),
				title: 'Election Night 2024 - Analysis'
			};
		}
	});
_Platform_export({'Analysis':{'init':$author$project$Analysis$main(
